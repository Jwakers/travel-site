...
var john = new __WEBPACK_IMPORTED_MODULE_0__modules_Person__["a" /* default */]('John Smith', 'blue');
john.greet();
...
function () {
  ...
  _createClass(Person, [{
    ...
    value: function greet() {
      console.log("Hello, my name is ".concat(this.name, " and my favourite colour is ").concat(this.favouriteColour, "."));
    }
  }]);
